...
nke_dividend = pd.read_csv("/PI02/Nike, Inc. Common Stock (NKE) Dividend History _ Nasdaq.csv")
mcd_dividend = pd.read_csv("/PI02/McDonald's Corporation Common Stock (MCD) Dividend History _ Nasdaq.csv")
